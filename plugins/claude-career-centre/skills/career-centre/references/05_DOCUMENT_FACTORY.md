...
7. Human visual inspection of every rendered page.
8. Paired cover-letter check unless `cv_only=true`.
9. Document-version entry in the Career Passport with source-document IDs, status and change summary.
10. Run-level manifest and checksum check.
