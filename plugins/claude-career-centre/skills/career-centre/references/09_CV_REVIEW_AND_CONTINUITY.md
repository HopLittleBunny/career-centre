...
The plugin package is installed once. Never ask the user to re-upload the package for each search or each day; only the latest Passport is needed when continuity must move to a new conversation.
