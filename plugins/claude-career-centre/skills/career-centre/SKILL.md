...
Do not claim the publisher stores nothing everywhere; Claude processes user files under its own terms. The accurate promise is that this skills-only plugin does not send CV or career data to an Amit-operated backend.
